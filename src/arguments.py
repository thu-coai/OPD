...
def add_inference_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument('--ppl-infer', default=False, action='store_true',
                       help='whether to use ppl infer')
    group.add_argument("--use_line_token_as_eos", action='store_true', help="set eos_token='\n' ")
    return parser
...
def add_training_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument('--dataset', type=str, default=None,
                       help='dataset name')
    group.add_argument('--prompt-tuning', default=False, action='store_true',
                       help='using prompt tuning')
